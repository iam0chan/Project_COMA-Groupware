<div align= "center">
    ...
    <div style="font-weight: 700; font-size: 15px; text-align: center; color: #c9d1d9;"> 
       Coma Academy ERP는 학원 내에서 사내 채팅을 통한 실시간 소통과 전자결재 시스템을 제공하여 업무 처리를 효율적으로 지원합니다.<br>
       근태 기능은 출근,퇴근,지각 등을 자동으로 기록하며, 일정 관리 기능은 업무 일정을 효과적으로 처리하고 관리합니다.<br>
       데이터 통계 분석을 통해 학원의 인사 및 운영 상태를 시각화 할 수 있습니다.
    </div> 
    </div>
    <div align= "center">
